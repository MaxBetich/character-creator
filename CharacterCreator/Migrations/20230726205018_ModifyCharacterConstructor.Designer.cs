...
namespace CharacterCreator.Migrations
{
    ...
    [Migration("20230726205018_ModifyCharacterConstructor")]
    partial class ModifyCharacterConstructor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharacterCreator.Models.Character", b =>
                {
                    ...
                    b.Property<string>("AdvancedProficiency")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("FortitudeSaveProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("HeavyArmorProficiency")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("LightArmorProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("MartialProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("MediumArmorProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("PerceptionProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("ReflexSaveProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("SimpleProficiency")
                        .HasColumnType("longtext");

                    b.Property<int>("Strength")
                        .HasColumnType("int");

                    b.Property<string>("UnarmedProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("UnarmoredProficiency")
                        .HasColumnType("longtext");

                    b.Property<string>("UserId")
                        .HasColumnType("varchar(255)");

                    b.Property<string>("WillSaveProficiency")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("CharacterCreator.Models.CharacterBoost", b =>
                {
                    b.Property<int>("CharacterBoostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("CharacterBoostId");

                    b.HasIndex("BoostId");

                    b.HasIndex("CharacterId");

                    b.ToTable("CharacterBoosts");
                });
            ...
            modelBuilder.Entity("CharacterCreator.Models.CharacterClass", b =>
                {
                    ...
                    b.Property<int>("StartingSkillCount")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            CharacterClassId = 1,
                            AdvancedProficiency = "Trained",
                            CharacterClassDescription = "Fighting for honor, greed, loyalty, or simply the thrill of battle, you are an undisputed master of weaponry and combat techniques. You combine your actions through clever combinations of opening moves, finishing strikes, and counterattacks whenever your foes are unwise enough to drop their guard. Whether you are a knight, mercenary, sharpshooter, or blade master, you have honed your martial skills into an art form and perform devastating critical attacks on your enemies.",
                            CharacterClassName = "Fighter",
                            ClassHitpoints = 10,
                            FortitudeSaveProficiency = "Expert",
                            HeavyArmorProficiency = "Trained",
                            KeyAbility = "Strength or Dexterity",
                            LightArmorProficiency = "Trained",
                            MartialProficiency = "Expert",
                            MediumArmorProficiency = "Trained",
                            PerceptionProficiency = "Expert",
                            ReflexSaveProficiency = "Expert",
                            SimpleProficiency = "Expert",
                            StartingSkillCount = 3,
                            UnarmedProficiency = "Expert",
                            UnarmoredProficiency = "Trained",
                            WillSaveProficiency = "Trained"
                        },
                        new
                        {
                            CharacterClassId = 2,
            ...
            modelBuilder.Entity("CharacterCreator.Models.CharacterClassSkill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CharacterClassSkillId = 1,
                            CharacterClassId = 1,
                            SkillId = 1
                        },
                        new
                        {
                            CharacterClassSkillId = 2,
                            CharacterClassId = 1,
                            SkillId = 3
                        },
                        new
                        {
                            CharacterClassSkillId = 3,
                            CharacterClassId = 3,
                            SkillId = 14
                        });
                });

            modelBuilder.Entity("CharacterCreator.Models.CharacterFlaw", b =>
                {
                    b.Property<int>("CharacterFlawId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("CharacterFlawId");

                    b.HasIndex("CharacterId");

                    b.HasIndex("FlawId");

                    b.ToTable("CharacterFlaws");
                });
